  ...
  <div class="product-wrap">
    <div class="product-up-inner">
      <div class="product-up-detail">
        <h2 class="product-detail-title">产品助手</h2>
...
<script>
    ...
    export default {
        ...
        components:{vSingleSelection,vMultipleSelection,vQuantity},
        data(){
            return{
                isShow : false,
                productsTypes:Array,
        ...
        methods:{
            ...
            getPrice () {
                ...
                this.$axios
                    .post('/api/getPrice',resParams)
                    .then((res)=>{
                        // console.log(res.data)
                        // let data = JSON.parse(res.data)
                        this.buyInformationList.totalPrices =res.data.amount;
                    })
            },
            submit(){
